...
class Dialog(BaseDialog):
	...
	def InstallControls(self):
		...
		body,dummy = self.creator.inputbox(_("コメント本文"), None, self.comment["message"], wx.TE_MULTILINE|wx.TE_READONLY|wx.TE_PROCESS_ENTER|wx.BORDER_RAISED, 500)
		...
		dt, dummy = grid.inputbox(_("コメント投稿日時"), None, dtstr, wx.TE_READONLY, 300)
		...
		introduction,dummy = self.creator.inputbox(_("自己紹介"), None, self.comment["from_user"]["profile"], wx.TE_MULTILINE|wx.TE_READONLY|wx.TE_PROCESS_ENTER, 500)
