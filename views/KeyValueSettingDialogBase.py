...
class KeyValueSettingDialogBase(BaseDialog):
	...
	def InstallControls(self):
		...
		self.hListCtrl, dummy=self.creator.listCtrl(_("現在の登録内容"), proportion=0, sizerFlag=wx.ALL|wx.ALIGN_CENTER_HORIZONTAL,size=(750,300),style=wx.LC_REPORT | wx.LC_NO_HEADER | wx.LC_SINGLE_SEL)
